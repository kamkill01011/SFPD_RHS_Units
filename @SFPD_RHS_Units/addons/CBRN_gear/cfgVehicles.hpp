		...
		class ACE_Actions
		{
			class ACE_Head
			{
				class CBRN_putMaskOn
				{
					...
					condition = "((_target call CBRN_fnc_hasMaskInInventory) || (_player call CBRN_fnc_hasMaskInInventory)) && (_target getVariable ['ACE_isUnconscious', false]) && !((goggles _target) in CBRN_allLevel1Masks)";
