...
private _isGL = [_ammoClass, "CBRN_isGL", 0] call BIS_fnc_returnConfigEntry;
...
[{
	...
	[_posArray vectorAdd [0,0, -((_posArray # 2) / 1.5)], _sprayWidth, _chemLifeTime, _chemType, (_posArray # 2) / 2, 0.4] call CBRN_fnc_spawnMist;
