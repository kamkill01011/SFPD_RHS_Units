...
private _dist = TFAR_currentUnit distance _unit;
...
// KAM
private _jamming = [_unit, TFAR_currentUnit] call TFAR_fnc_calcJamming;
_jamming = [_jamming, 0, 1] call BIS_fnc_clamp;
if (_jamming > 0) then {
	private _curr_radio_range = 5000;// TODO ...
