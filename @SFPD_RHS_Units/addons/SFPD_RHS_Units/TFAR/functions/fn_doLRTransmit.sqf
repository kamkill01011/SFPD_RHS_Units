...
private _hintText = format[
                            ...
                            format ["%1<img size='1.5' image='%2'/>",
                                    ([_radio select 0, "displayName"] call TFAR_fnc_getLrRadioProperty) select [0, _MAX_RADIONAME_LEN],
...
private _range = [_radio select 0, "tf_range"] call TFAR_fnc_getLrRadioProperty;
