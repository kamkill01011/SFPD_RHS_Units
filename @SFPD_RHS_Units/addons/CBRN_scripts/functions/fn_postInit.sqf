...
CBRN_permanentContaminatedAreas = [[], [], []];

CBRN_contaminatedObject = [];
...
//This will contain all masks that protect against level 1 and up
CBRN_allLevel2Suits = ("(8) <= getNumber (_x >> 'CBRN_protectionLevel')" configClasses (configFile >> "cfgWeapons")) apply {configName _x};
