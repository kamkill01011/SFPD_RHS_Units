...
["CBRN_exposureCoughThreshold", "SLIDER", ["Cough Threshold", "Change the threshold at which units cough from exposure (0 to disable)"], ["Chemical Warfare", "Exposure Thresholds"], [0, 90, 4, 1], 1] call cba_settings_fnc_init;
["CBRN_exposureLimpThreshold", "SLIDER", ["Limp Threshold", "Change the threshold at which units limp from exposure (0 to disable)"], ["Chemical Warfare", "Exposure Thresholds"], [0, 90, 40, 1], 1] call cba_settings_fnc_init;
["CBRN_exposureKnockoutThreshold", "SLIDER", ["Unconscious Threshold", "Change the threshold at which units go unconscious from exposure (0 to disable)"], ["Chemical Warfare", "Exposure Thresholds"], [0, 90, 80, 1], 1] call cba_settings_fnc_init;
["CBRN_exposureDeathThreshold", "SLIDER", ["Death Threshold", "Change the threshold at which units die from exposure (0 to disable)"], ["Chemical Warfare", "Exposure Thresholds"], [0, 90, 90, 1], 1] call cba_settings_fnc_init;
